...
echo "<form name='update' method='POST' action='updating' class= 'well'>";

echo "<h3>Edit Publisher Data</h3>";
echo "<table border='0' class='tabledetail'>";

echo "<input type='hidden' name='cpid' value='$edited'>";
echo "<input type='hidden' name='cname' value='$cpname'>";
echo "<tr>"."<td>"."Company name"."</td>"."<td>"."<input type='text' name='companyname' value='$cpname'>"."</td><td>".form_error('companyname')."</td>";
if($msg != NULL)
{
  echo "<td>".$msg."</td>";
}  
...
echo "</tr>";
echo "<td>"."Address"."</td>"."<td>"."  <input type='text' name='address' value='$cpadd'>"."</td><td>".form_error('address')."</td>"."</tr>";
echo "<td>"."State "."</td>"."<td>"." <input type='text' name='state' value='$cpstate'>"."</td><td>".form_error('state')."</td>"."</tr>";
...
foreach ($query2->result() as $row)
{
   ...
   if($name==$cpcountry)
   {
   echo "<option value='".$cpcountry."' selected='selected' >".$cpcountry."</option>";
   }
  else
  {
...
echo"</select></td></tr>";
echo "<td>"."Contact  "."</td>"."<td>"." <input type='text' name='contact' value='$cpcontact'>"."</td><td>".form_error('contact')."</td>"."</tr>";
     
     echo "<td>"."<input type=submit class='btn btn-primary' value='Update' >"."</td>"."</tr>";
